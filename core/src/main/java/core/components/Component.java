...
public abstract class Component {
    ...
    protected final CoreConstants.ComponentType type;  // Type of this component
    ...
    public Component(CoreConstants.ComponentType type, String name) {
        this.componentID = ID++;
        this.type = type;
    ...
    public Component(CoreConstants.ComponentType type) {
        this.componentID = ID++;
        this.type = type;
    ...
    protected Component(CoreConstants.ComponentType type, String name, int componentID) {
    ...
    protected Component(CoreConstants.ComponentType type, int componentID) {
        this.componentID = componentID;
        this.type = type;
        this.componentName = type.toString();
        this.properties = new HashMap<>();
     ...
     */
    public CoreConstants.ComponentType getType()                   {
        return this.type;
    }
