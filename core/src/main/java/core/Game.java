...
//                System.out.println("Game " + i + "/" + nRepetitions);
    ...
    public final void run() {
        ...
        listeners.forEach(l -> l.onEvent(evaluation.metrics.Event.createEvent(evaluation.metrics.Event.GameEvent.ABOUT_TO_START, gameState)));
    ...
    public final core.actions.AbstractAction oneAction() {
        ...
        s = System.nanoTime();
        List<core.actions.AbstractAction> observedActions = forwardModel.computeAvailableActions(observation, currentPlayer.getParameters().actionSpace);
        if (observedActions.isEmpty()) {
            ...
            core.actions.AbstractAction lastAction = null;
        ...
        if (!observedActions.isEmpty()) {
            ...
            listeners.forEach(l -> l.onEvent(evaluation.metrics.Event.createEvent(evaluation.metrics.Event.GameEvent.ACTION_CHOSEN, gameState, finalAction, activePlayer)));
        ...
        listeners.forEach(l -> l.onEvent(evaluation.metrics.Event.createEvent(evaluation.metrics.Event.GameEvent.ACTION_TAKEN, gameState, finalAction1.copy(), activePlayer)));
    ...
    private void terminate() {
        ...
        listeners.forEach(l -> l.onEvent(evaluation.metrics.Event.createEvent(evaluation.metrics.Event.GameEvent.GAME_OVER, gameState)));
    ...
    public static void main(String[] args) {
        String gameType = Utils.getArg(args, "game", "Battlelore");
