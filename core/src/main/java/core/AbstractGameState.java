...
public abstract class AbstractGameState {
    ...
    protected void reset() {
        ...
        gameStatus = CoreConstants.GameResult.GAME_ONGOING;
        playerResults = new CoreConstants.GameResult[getNPlayers()];
        Arrays.fill(playerResults, CoreConstants.GameResult.GAME_ONGOING);
    ...
    public final boolean isNotTerminal() {
        return gameStatus == CoreConstants.GameResult.GAME_ONGOING;
    }

    public final boolean isNotTerminalForPlayer(int player) {
        return playerResults[player] == CoreConstants.GameResult.GAME_ONGOING && gameStatus == CoreConstants.GameResult.GAME_ONGOING;
    }
