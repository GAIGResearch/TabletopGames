...
public class ToadCard extends Card {
    ...
    public ToadCard(String name, int value, ToadConstants.ToadCardType type, ToadAbility ability, ToadAbility tactics) {
        super(name);
        this.value = value;
    ...
    public ToadCard(String name, int value, ToadConstants.ToadCardType type) {
        this(name, value, type, type == null ? null : type.defaultAbility, type == null ? null : type.defaultAbility);
    }
    public ToadCard(String name, int value, ToadConstants.ToadCardType type, ToadAbility ability) {
