...
public class LoveLetterPlayerView extends JPanel {
    ...
    public LoveLetterPlayerView(Deck<LoveLetterCard> hand, Deck<LoveLetterCard> discard, int playerId, Set<Integer> humanId, String dataPath) {
        ...
        handCards = new LoveLetterDeckView(playerId, hand, false, dataPath,
                new Rectangle(0, 0, LoveLetterGUIManager.playerAreaWidth / 2 - border * 2, LoveLetterGUIManager.llCardHeight));
        ...
        this.width = LoveLetterGUIManager.playerAreaWidth + border * 2;
        this.height = LoveLetterGUIManager.playerAreaHeight + border + borderBottom*2;
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString(nPoints + "/" + nPointsWin + " affection tokens", border + buffer, LoveLetterGUIManager.llCardHeight + borderBottom*2);
    }
