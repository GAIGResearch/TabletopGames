...
public class LoveLetterHeuristic extends TunableParameters implements IStateHeuristic {
    ...
    public double evaluateState(AbstractGameState gs, int playerId) {
        ...
        if (cardTypes.contains(LoveLetterCard.CardType.Countess)) retValue += FACTOR_COUNTESS;
        if (cardTypes.contains(LoveLetterCard.CardType.King)) retValue += FACTOR_KING;
        if (cardTypes.contains(LoveLetterCard.CardType.Baron)) retValue += FACTOR_BARON;
        if (cardTypes.contains(LoveLetterCard.CardType.Handmaid)) retValue += FACTOR_HANDMAID;
        if (cardTypes.contains(LoveLetterCard.CardType.Guard)) retValue += FACTOR_GUARD;
        if (cardTypes.contains(LoveLetterCard.CardType.Priest)) retValue += FACTOR_PRIEST;
        if (cardTypes.contains(LoveLetterCard.CardType.Prince)) retValue += FACTOR_PRINCE;
        if (cardTypes.contains(LoveLetterCard.CardType.Princess)) retValue += FACTOR_PRINCESS;
