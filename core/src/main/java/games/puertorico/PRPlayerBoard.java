...
public class PRPlayerBoard extends Component {
    ...
    Map<PuertoRicoConstants.Crop, Integer> stores;
    Set<PuertoRicoConstants.Crop> cropsInWarehouses;
    int vp;
    ...
    public int getStoresOf(PuertoRicoConstants.Crop crop) {
    ...
    public void harvest(PuertoRicoConstants.Crop crop, int amount) {
    ...
    public Map<PuertoRicoConstants.Crop, Integer> getStores() {
        return new HashMap<>(this.stores);
    }

    public int getPlantationsOf(PuertoRicoConstants.Crop crop) {
    ...
    public Set<PuertoRicoConstants.Crop> getCropsInWarehouses() {
        return cropsInWarehouses;
    }
    public void store(PuertoRicoConstants.Crop crop) {
