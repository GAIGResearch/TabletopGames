...
public class StrategoBoardView extends ComponentView {
    ...
    public StrategoBoardView(StrategoGameState gs) {
        super(gs.getGridBoard(), gs.getGridBoard().getWidth() * GUI.defaultItemSize,
                gs.getGridBoard().getHeight() * GUI.defaultItemSize);
    ...
    private void drawCell(Graphics2D g, Piece piece, int x, int y) {
        ...
        if ((x==100 && y==200) || (x==100 && y==250) || (x==150 && y==200) || (x==150 && y==250)
            ...
            g.drawString(symbol, x + GUI.defaultItemSize / 16, y + GUI.defaultItemSize - GUI.defaultItemSize / 16);
            g.setFont(f);
        }
...
//            }
            g.drawString(elementName, x + GUI.defaultItemSize / 16, y + GUI.defaultItemSize - GUI.defaultItemSize / 16);
            g.setFont(f);
        }
    }
