...
public class ColtExpressParameters extends TunableParameters {
    ...
    public ColtExpressTypes.CharacterType[] characterTypes = new ColtExpressTypes.CharacterType[]{
            ColtExpressTypes.CharacterType.Ghost,
            ColtExpressTypes.CharacterType.Cheyenne,
            ColtExpressTypes.CharacterType.Django,
            ColtExpressTypes.CharacterType.Tuco,
            ColtExpressTypes.CharacterType.Doc,
            ColtExpressTypes.CharacterType.Belle
    };
    ...
    public ColtExpressTypes.EndRoundCard[] endRoundCards = new ColtExpressTypes.EndRoundCard[]{
            ColtExpressTypes.EndRoundCard.MarshallsRevenge,
            ColtExpressTypes.EndRoundCard.Hostage,
            ColtExpressTypes.EndRoundCard.PickPocket
    };
    ...
    public ColtExpressTypes.RegularRoundCard[] roundCards = new ColtExpressTypes.RegularRoundCard[]{
            ColtExpressTypes.RegularRoundCard.AngryMarshall,
            ColtExpressTypes.RegularRoundCard.Braking,
            ColtExpressTypes.RegularRoundCard.Bridge,
            ColtExpressTypes.RegularRoundCard.PassengerRebellion,
            ColtExpressTypes.RegularRoundCard.SwivelArm,
            ColtExpressTypes.RegularRoundCard.TakeItAll,
            ColtExpressTypes.RegularRoundCard.Tunnel
    };
    ...
    public ArrayList<HashMap<ColtExpressTypes.LootType, Integer>> trainCompartmentConfigurations = new ArrayList<HashMap<ColtExpressTypes.LootType, Integer>>() {{
        add(new HashMap<ColtExpressTypes.LootType, Integer>() {{
            put(ColtExpressTypes.LootType.Purse, 1);
        }});
        add(new HashMap<ColtExpressTypes.LootType, Integer>() {{
            put(ColtExpressTypes.LootType.Purse, 2);
        }});
        add(new HashMap<ColtExpressTypes.LootType, Integer>() {{
            put(ColtExpressTypes.LootType.Purse, 3);
        }});
        add(new HashMap<ColtExpressTypes.LootType, Integer>() {{
            put(ColtExpressTypes.LootType.Purse, 1);
        ...
        add(new HashMap<ColtExpressTypes.LootType, Integer>() {{
            put(ColtExpressTypes.LootType.Purse, 4);
            put(ColtExpressTypes.LootType.Jewel, 1);
        }});
        add(new HashMap<ColtExpressTypes.LootType, Integer>() {{
    ...
    public ArrayList<Group<ColtExpressTypes.LootType, Integer, Integer>> playerStartLoot = new ArrayList<Group<ColtExpressTypes.LootType, Integer, Integer>>() {{
        add(new Group<>(ColtExpressTypes.LootType.Purse, 250, 1));
    }};
    ...
    public HashMap<ColtExpressTypes.LootType, ArrayList<Pair<Integer, Integer>>> loot = new HashMap<ColtExpressTypes.LootType, ArrayList<Pair<Integer, Integer>>>() {{
        put(ColtExpressTypes.LootType.Purse, new ArrayList<Pair<Integer, Integer>>() {{
            add(new Pair<>(250, 8));
            add(new Pair<>(300, 2));
            add(new Pair<>(350, 2));
            add(new Pair<>(400, 2));
        ...
        put(ColtExpressTypes.LootType.Jewel, new ArrayList<Pair<Integer, Integer>>() {{
            add(new Pair<>(500, 6));
        }});
        put(ColtExpressTypes.LootType.Strongbox, new ArrayList<Pair<Integer, Integer>>() {{
            add(new Pair<>(1000, 2));
        }});
    }};
