...
public class ColtExpressGameState extends AbstractGameStateWithTurnOrder implements IPrintable {
    ...
    HashMap<Integer, ColtExpressTypes.CharacterType> playerCharacters;
...
//                    dLoot.add(new Loot(LootType.Unknown, 0));  // Unknown loot
    ...
    void distributeCards(){
        for (int playerIndex = 0; playerIndex < getNPlayers(); playerIndex++) {
            ...
            if (playerCharacters.get(playerIndex) == ColtExpressTypes.CharacterType.Doc) {
    ...
    public HashMap<Integer, ColtExpressTypes.CharacterType> getPlayerCharacters() {
