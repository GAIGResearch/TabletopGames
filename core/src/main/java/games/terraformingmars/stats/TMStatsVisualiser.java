...
public class TMStatsVisualiser extends StatsVisualiser {
    ...
    public TMStatsVisualiser(List<MetricsGameListener> listeners) {
        ...
        // Generation average
        visualiseMetricAsDotPlot("Generation", GAME_OVER, 0, 30);
        ...
        // Global parameters
        visualiseMetricAsDotPlot("ParameterComplete (OceanTiles)", GAME_OVER, 0, 30);
        visualiseMetricAsDotPlot("ParameterComplete (Oxygen)", GAME_OVER, 0, 30);
        visualiseMetricAsDotPlot("ParameterComplete (Temperature)", GAME_OVER, 0, 30);
        ...
        for (int i = 0; i < playerBoardResources.length; i++) {
            resources[i] = ((TAGNumericStatSummary) getStats("PlayerResource (" + playerBoardResources[i].name() + "):All", GAME_OVER)).mean();
            resourceProduction[i] = ((TAGNumericStatSummary) getStats("PlayerProduction (" + playerBoardResources[i].name() + "):All", GAME_OVER)).mean();
        ...
        // Map coverage
        TAGNumericStatSummary stats = visualiseNumericMetricAsLabel("MapCoverage", GAME_OVER);
//        getContentPane().add(new JLabel(String.format("%30s  %8.3g%% +/- %6.2g", "Map coverage:", stats.mean()*100, stats.sd()*100)), gridBagConstraints);
        ...
        fm.setup(gs);
        TAGOccurrenceStatSummary stats2 = (TAGOccurrenceStatSummary)getStats("MapTiles", GAME_OVER);
        ...
        // Score gap
        visualiseNumericMetricAsLabel("PointDifference", GAME_OVER, "Score gap");
...
//        visualiseNumericMetricAsLabel("PlayerCardsPlayed:All", Event.GameEvent.GAME_OVER, "Cards played");
        visualiseNumericMetricAsLabel("PlayerPlayedCardsPerType (Automated):All", GAME_OVER, "Cards played (automated)");
        visualiseNumericMetricAsLabel("PlayerPlayedCardsPerType (Active):All", GAME_OVER, "Cards played (active)");
        visualiseNumericMetricAsLabel("PlayerPlayedCardsPerType (Event):All", GAME_OVER, "Cards played (event)");
        ...
        TAGOccurrenceStatSummary summary = (TAGOccurrenceStatSummary) getStats("PlayerCardsPlayedWin:All", GAME_OVER);
        TAGOccurrenceStatSummary summary2 = (TAGOccurrenceStatSummary) getStats("PlayerAllCardsPlayed:All", GAME_OVER);
        ...
        double[] data = new double[] {
            ((TAGNumericStatSummary)getStats("PlayerPointsTR:All", GAME_OVER)).mean(),
            ((TAGNumericStatSummary)getStats("PlayerPointsMilestones:All", GAME_OVER)).mean(),
            ((TAGNumericStatSummary)getStats("PlayerPointsAwards:All", GAME_OVER)).mean(),
            ((TAGNumericStatSummary)getStats("PlayerPointsCards:All", GAME_OVER)).mean(),
            ((TAGNumericStatSummary)getStats("PlayerPointsBoard:All", GAME_OVER)).mean(),
        };
