    ...
    protected void _setup(AbstractGameState firstState) {
        ...
        for (int i = 0; i < gs.getNPlayers(); i++) {
            ...
            for (TMTypes.Resource res : TMTypes.Resource.values()) {
                ...
                if (res == TMTypes.Resource.TR && gs.getNPlayers() == 1) {
...
//        }
        ...
        gs.setGamePhase(TMGameState.TMPhase.CorporationSelect);
        for (int i = 0; i < gs.getNPlayers(); i++) {
...
//            }
    ...
    protected void _afterAction(AbstractGameState currentState, AbstractAction action) {
        ...
        if (gs.getGamePhase() == TMGameState.TMPhase.CorporationSelect) {
            ...
            if (allChosen) {
                gs.setGamePhase(TMGameState.TMPhase.Research);
...
//                    }
        ...
        } else if (gs.getGamePhase() == TMGameState.TMPhase.Research) {
            ...
            if (allDone) {
                gs.setGamePhase(TMGameState.TMPhase.Actions);
                gs.getTurnOrder().endRound(gs);
            }
        } else if (gs.getGamePhase() == TMGameState.TMPhase.Actions) {
    ...
    public List<AbstractAction> getAllActions(TMGameState gs) {
        ...
        if (gs.getGamePhase() == TMGameState.TMPhase.CorporationSelect) {
            ...
            possibleActions.add(new ModifyPlayerResource(TMTypes.StandardProject.PowerPlant, params.getnCostSPEnergy(), player, 1, TMTypes.Resource.Energy));

            // - Increase temperature 1 step for 14 MC
            possibleActions.add(new ModifyGlobalParameter(TMTypes.ActionType.StandardProject, TMTypes.Resource.MegaCredit, params.getnCostSPTemp(), TMTypes.GlobalParameter.Temperature, 1, false));

            // - Place ocean tile for 18 MC
            possibleActions.add(new PlaceTile(TMTypes.StandardProject.Aquifer, params.getnCostSPOcean(), player, TMTypes.Tile.Ocean, TMTypes.MapTileType.Ocean));

            // - Place greenery tile for 23 MC
            possibleActions.add(new PlaceTile(TMTypes.StandardProject.Greenery, params.getnCostSPGreenery(), player, TMTypes.Tile.Greenery, TMTypes.MapTileType.Ground));
            ...
            possibleActions.add(new CompoundAction(TMTypes.ActionType.StandardProject, player, new TMAction[]{a1, a2}, params.nCostSPCity));
            ...
            if (params.expansions.contains(TMTypes.Expansion.Venus)) {
                possibleActions.add(new ModifyGlobalParameter(TMTypes.ActionType.StandardProject, TMTypes.Resource.MegaCredit, params.nCostVenus, TMTypes.GlobalParameter.Venus, 1, false));
            }
            ...
            possibleActions.add(new ModifyGlobalParameter(TMTypes.ActionType.BasicResourceAction, TMTypes.Resource.Heat, params.getnCostTempHeat(), TMTypes.GlobalParameter.Temperature, 1, false));
        }
