...
//        System.out.println(Arrays.toString(GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames()));
    ...
    private void drawBoard(Graphics2D g) {
        ...
        if (playerDiscardDeck != null) {
            ...
            g.setFont(f);
            PandemicCardView.drawCard(g, cP, null, new Rectangle(playerDiscardDeckLocation.x + panX, playerDiscardDeckLocation.y + panY, playerDiscardDeckLocation.width, playerDiscardDeckLocation.height));
        }
        g.setFont(labelFontS);
        ...
        if (infectionDiscardDeck != null) {
            ...
            g.setFont(f);
            PandemicCardView.drawCard(g, cI, null, new Rectangle(infectionDiscardDeckLocation.x + panX, infectionDiscardDeckLocation.y + panY, infectionDiscardDeckLocation.width, infectionDiscardDeckLocation.height));
        }
        g.setFont(labelFontS);
        ...
        if (plannerDeck != null) {
            ...
            g.setFont(f);
            PandemicCardView.drawCard(g, cI, null, new Rectangle(plannerDeckLocation.x + panX, plannerDeckLocation.y + panY, plannerDeckLocation.width, plannerDeckLocation.height));
        }
        g.setFont(labelFontS);
        g.drawString("Planner Deck", (int)plannerDeckLocation.getX() + panX, (int)plannerDeckLocation.getY() - fontSize + panY);

        DeckView.drawDeck(g, (Deck<Card>) gameState.getComponent(infectionHash), null, cardBackInf, new Rectangle(infectionDeckLocation.x + panX, infectionDeckLocation.y + panY, infectionDeckLocation.width, infectionDeckLocation.height), false);
        g.drawString("Infection Deck", (int)infectionDeckLocation.getX() + panX, panY + (int)infectionDeckLocation.getY() - fontSize);
        DeckView.drawDeck(g, (Deck<Card>) gameState.getComponent(playerDeckHash), null, cardBackPD, new Rectangle(playerDeckLocation.x + panX, playerDeckLocation.y + panY, playerDeckLocation.width, playerDeckLocation.height), false);
