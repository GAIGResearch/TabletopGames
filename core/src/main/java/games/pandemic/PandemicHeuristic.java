...
public class PandemicHeuristic extends TunableParameters implements IStateHeuristic {
    ...
    public double evaluateState(AbstractGameState gs, int playerId) {
        ...
        for (String resStationLocation: pgs.researchStationLocations){
            if (((PropertyString) pgs.getComponentActingPlayer(PandemicConstants.playerCardHash).getProperty(PandemicConstants.playerLocationHash)).value.equals(resStationLocation)){
