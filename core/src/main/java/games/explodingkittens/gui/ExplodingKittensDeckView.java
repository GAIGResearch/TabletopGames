...
public class ExplodingKittensDeckView extends DeckView<ExplodingKittensCard> {
    ...
    public ExplodingKittensDeckView(int player, Deck<ExplodingKittensCard> d, boolean visible, String dataPath) {
        super(player, d, visible, ExplodingKittensGUIManager.ekCardWidth, ExplodingKittensGUIManager.ekCardHeight, new Rectangle(5, 5, ExplodingKittensGUIManager.playerAreaWidth, ExplodingKittensGUIManager.playerAreaHeight));
    ...
    private void drawCat(Graphics2D g, ExplodingKittensCard card, Rectangle r, boolean visible) {
        ...
        if (visible) {
            ...
            g.drawImage(catImg, r.x + ExplodingKittensGUIManager.ekCardWidth / 2 - defaultItemSize / 2, r.y + ExplodingKittensGUIManager.ekCardHeight / 2, defaultItemSize, height, null);
        }
    }
