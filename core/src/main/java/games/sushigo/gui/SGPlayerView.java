...
//        this.height = playerAreaHeight + border + borderBottom;
        ...
        this.playerHandView = new SGDeckView(playerId, deck, true, dataPath, new Rectangle(border, border, SGGUIManager.playerAreaWidth-50, SGGUIManager.playerAreaHeight));
        this.playedCardsView = new SGDeckView(playerId, playDeck, true, dataPath, new Rectangle(border, border, SGGUIManager.playerAreaWidth-50, SGGUIManager.playerAreaHeight));
