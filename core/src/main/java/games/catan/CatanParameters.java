...
public class CatanParameters extends TunableParameters {
    ...
    public HashMap<BuyAction.BuyType, HashMap<Resource, Integer>> costMapping = new HashMap<BuyAction.BuyType, HashMap<Resource, Integer>>(){{
        ...
        put(BuyAction.BuyType.Settlement, new HashMap<Resource, Integer>() {{
            put(BRICK, 1);
            put(LUMBER, 1);
            put(GRAIN, 1);
            put(WOOL, 1);
        }});
        put(BuyAction.BuyType.City, new HashMap<Resource, Integer>() {{
            put(ORE, 3);
            put(GRAIN, 2);
        }});
        put(BuyAction.BuyType.Road, new HashMap<Resource, Integer>() {{
            put(BRICK, 1);
            put(LUMBER, 1);
        }});
        put(BuyAction.BuyType.DevCard, new HashMap<Resource, Integer>() {{
            put(ORE, 1);
            put(GRAIN, 1);
            put(WOOL, 1);
        }});
    ...
    HashMap<BuyAction.BuyType, Integer> tokenCounts = new HashMap<BuyAction.BuyType, Integer>() {{
        put(BuyAction.BuyType.Settlement, 5);
        put(BuyAction.BuyType.City, 4);
        put(BuyAction.BuyType.Road, 15);
    }};
