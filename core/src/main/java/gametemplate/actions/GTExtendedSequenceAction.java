...
public class GTExtendedSequenceAction extends AbstractAction implements IExtendedSequence {
    ...
    /**
     * Forward Model delegates to this from {@link StandardForwardModel#computeAvailableActions(AbstractGameState)}
    ...
    /**
     * TurnOrder delegates to this from {@link TurnOrder#getCurrentPlayer(AbstractGameState)}
     * if this Extended Sequence is currently active.
     *
     * @param state The current game state
