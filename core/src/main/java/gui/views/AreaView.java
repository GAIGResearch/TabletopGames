...
public class AreaView extends ComponentView {
    ...
    private Deck<? extends core.components.Component> deckHighlight;  // Top deck being highlighted, contents can be displayed in GUI
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (e.getButton() == MouseEvent.BUTTON3) {
                    ...
                    for (Map.Entry<Integer, Rectangle> en : drawMap.entrySet()) {
                        core.components.Component c = area.getComponents().get(en.getKey());
                        ...
                        for (Map.Entry<Integer, Rectangle> en : drawMap.entrySet()) {
                            ...
                            if (r.contains(e.getPoint())) {
                                ...
                                if (c instanceof Deck) {
                                    deckHighlight = (Deck<? extends core.components.Component>) c;
                                    continue;
                                }
    ...
    public static void drawArea(Graphics2D g, Area area, int x, int y, int width, int height,
        ...
        List<Deck<? extends core.components.Component>> decks = new ArrayList<>();
        List<Area> areas = new ArrayList<>();
        for (Map.Entry<Integer, core.components.Component> e: area.getComponentsMap().entrySet()) {
            Rectangle r = drawMap.get(e.getKey());
            Point t = translation.get(e.getKey());

            if (e.getValue() instanceof Deck) {
                decks.add((Deck<? extends core.components.Component>) e.getValue());
        ...
        // Draw components
        for (Map.Entry<Integer, core.components.Component> e: area.getComponentsMap().entrySet()) {
            core.components.Component c = e.getValue();
            ...
            if (!dependencies.containsKey(e.getKey())) {
                ...
                for (Deck<? extends core.components.Component> d : decks) {
