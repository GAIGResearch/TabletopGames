...
public class GridBoardView<T extends core.components.Component> extends ComponentView {
    ...
    public static <T extends core.components.Component> void drawGridBoard(Graphics2D g, GridBoard<T> gridBoard, int x, int y) {
    ...
    public static <T extends core.components.Component> void drawGridBoard(Graphics2D g, GridBoard<T> gridBoard, Rectangle rect) {
        // Draw background
        g.setColor(Color.lightGray);
