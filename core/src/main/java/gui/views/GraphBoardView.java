    ...
    public static void drawGraphBoard(Graphics2D g, GraphBoard graphBoard, int x, int y, int width, int height) {
        ...
        for (BoardNode b: bList) {
            ...
            if (posProp != null) {
                ...
                PropertyBoolean edge = ((PropertyBoolean) b.getProperty(PandemicConstants.edgeHash));
                ...
                for (BoardNode b2 : neighbours) {
                    ...
                    if (posProp2 != null) {
                        ...
                        PropertyBoolean edge2 = ((PropertyBoolean) b2.getProperty(PandemicConstants.edgeHash));
