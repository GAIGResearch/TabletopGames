...
public abstract class DeckView<T extends core.components.Component> extends ComponentView {
...
//            }
     ...
     */
    public static <T extends core.components.Component> void drawDeck(Graphics2D g, Deck<T> deck, String name, Image background,
