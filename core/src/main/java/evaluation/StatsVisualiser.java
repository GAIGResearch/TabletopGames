...
public abstract class StatsVisualiser extends JFrame {
    private final Map<evaluation.metrics.Event.GameEvent, IStatisticLogger> loggers;
...
//        setExtendedState(JFrame.MAXIMIZED_BOTH);
     ...
     */
    protected TAGStatSummary getStats(String metricName, evaluation.metrics.Event.GameEvent event) {
     ...
     */
    protected void visualiseMetricAsDotPlot(String metricName, evaluation.metrics.Event.GameEvent event, int minY, int maxY, String alternatePrintName) {
    ...
    protected void visualiseMetricAsDotPlot(String metricName, evaluation.metrics.Event.GameEvent event, int minY, int maxY) {
     ...
     * @return
     */
    protected TAGNumericStatSummary visualiseNumericMetricAsLabel(String metricName, evaluation.metrics.Event.GameEvent event, String alternatePrintName) {
        gridBagConstraints.gridy++;
