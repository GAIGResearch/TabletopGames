...
public class MultiTreeNode extends SingleTreeNode {
    ...
    public MultiTreeNode(MCTSPlayer player, AbstractGameState state, Random rnd) {
        ...
        roots[this.decisionPlayer] = createRootNode(player, state, rnd, player.getFactory());
        if (params.paranoid)
    ...
    public void oneSearchIteration() {
        ...
        do {
            ...
            if (roots[currentActor] == null) {
                ...
                SingleTreeNode pseudoRoot = createRootNode(mctsPlayer, currentState.copy(), rnd, mctsPlayer.getFactory());
