...
class BasicTreeNode {
    ...
    private AbstractAction ucb() {
        ...
        for (AbstractAction action : children.keySet()) {
            ...
            uctValue = Utils.noise(uctValue,params.epsilon, player.getRnd().nextDouble());
    ...
    AbstractAction bestAction() {
        ...
        for (AbstractAction action : children.keySet()) {
            if (children.get(action) != null) {
                ...
                // Apply small noise to break ties randomly
                childValue = Utils.noise(childValue, player.getParameters().epsilon, player.getRnd().nextDouble());
