...
public class MCTSTreeSelectionTests {
    ...
    players.mcts.LMRForwardModel fm = new players.mcts.LMRForwardModel();
    ...
    public void testFPU() {
        ...
        Assert.assertEquals(20000, results[0], 0.001);
        Assert.assertEquals(20000, results[1], 0.001);
        Assert.assertEquals(20000, results[2], 0.001);
        ...
        Assert.assertEquals(1.0 + exploration, results[1], 0.001);
        Assert.assertEquals(20000, results[2], 0.001);
    ...
    public void ucb10Visits() {
        ...
        Assert.assertEquals(0.52, actionValues[0], 0.01);
        Assert.assertEquals(1.18, actionValues[1], 0.01);
        Assert.assertEquals(1.16, actionValues[2], 0.01);
    ...
    public void ucb10VisitsNormalised() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.0 + Math.sqrt(Math.log(10)), actionValues[0], 0.01);
        Assert.assertEquals(1.0 + Math.sqrt(Math.log(10) / 5), actionValues[1], 0.01);
        Assert.assertEquals(1.4 / 1.5 + Math.sqrt(Math.log(10) / 4), actionValues[2], 0.01);
        assertEquals(new LMRAction("Right"), node.treePolicyAction(true));
    ...
    public void ucb20Visits() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.73, actionValues[0], 0.01);
        Assert.assertEquals(1.05, actionValues[1], 0.01);
        Assert.assertEquals(0.98, actionValues[2], 0.01);
        assertEquals(new LMRAction("Middle"), node.treePolicyAction(true));
    }
    ...
    public void ucb40Visits() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.92, actionValues[0], 0.01);
        Assert.assertEquals(0.90, actionValues[1], 0.01);
        Assert.assertEquals(0.88, actionValues[2], 0.01);
    ...
    public void rm10Visits() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.00, actionValues[0], 0.01);
        ...
        Assert.assertEquals(0.09 * actionValues[1] / 0.19, actionValues[2], 0.01);
        ...
        Assert.assertEquals(1000, counts[0] + counts[1] + counts[2]);
        Assert.assertEquals(0, counts[0], 0);
        Assert.assertEquals(679, counts[1], 100);
        Assert.assertEquals(321, counts[2], 100);
    }
    ...
    public void rm10VisitsFinalSelection() {
        ...
        Assert.assertEquals(1000, counts[0] + counts[1] + counts[2]);
        Assert.assertEquals(0, counts[0], 0);
        Assert.assertEquals(680 / 2, counts[1], 100);
        Assert.assertEquals((320 + 1000) / 2, counts[2], 100);
        ...
        Assert.assertEquals(1000, counts[0] + counts[1] + counts[2]);
        Assert.assertEquals( (840)/3, counts[0], 50);
        Assert.assertEquals(680 / 3, counts[1], 50);
        Assert.assertEquals((320 + 1000 + 160) / 3, counts[2], 100);
    }
    ...
    public void rm10VisitsWithExploration() {
        ...
        Assert.assertEquals(1000, countsWithExploration[0] + countsWithExploration[1] + countsWithExploration[2]);
        Assert.assertEquals(100, countsWithExploration[0], 50);
        Assert.assertEquals(611, countsWithExploration[1], 50);
        Assert.assertEquals(289, countsWithExploration[2], 50);

        Assert.assertEquals(1000, countsWithoutExploration[0] + countsWithoutExploration[1] + countsWithoutExploration[2]);
        Assert.assertEquals(0, countsWithoutExploration[0], 0);
        Assert.assertEquals(679, countsWithoutExploration[1], 50);
        Assert.assertEquals(321, countsWithoutExploration[2], 50);
    }
    ...
    public void rm40Visits() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.0, actionValues[0], 0.01);
        Assert.assertTrue(actionValues[1] > 0.0);
        Assert.assertEquals(0.0, actionValues[2], 0.01);
        assertEquals(new LMRAction("Middle"), node.treePolicyAction(true));
    }
    ...
    public void exp3_10Visits() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(Math.exp(0.0), actionValues[0], 0.01);  // 1.0
        Assert.assertEquals(Math.exp(1.0 / 0.80), actionValues[1], 0.01); // 3.49
        Assert.assertEquals(Math.exp(0.93333 / 0.80), actionValues[2], 0.01); // 3.21
        // The final choice of action is then stochastic
        int[] counts = new int[3];
        for (int i = 0; i < 1000; i++) {
            AbstractAction action = node.treePolicyAction(true);
        ...
        Assert.assertEquals(1000, counts[0] + counts[1] + counts[2]);
        Assert.assertEquals(0.13 * 700 + 100, counts[0], 50);
        Assert.assertEquals(0.45 * 700 + 100, counts[1], 50);
        Assert.assertEquals(0.42 * 700 + 100, counts[2], 50);
    }
    ...
    public void bias10Visits() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.3 + Math.sqrt(Math.log(10)), actionValues[0], 0.01);
        Assert.assertEquals(1.0 + Math.sqrt(Math.log(10) / 5), actionValues[1], 0.01);
        Assert.assertEquals(0.4 + 1.4 / 1.5 + Math.sqrt(Math.log(10) / 4), actionValues[2], 0.01);
    ...
    public void pUCT10VisitsNoTemperature() {
        ...
        // Right: 1.0 / 1.0 = 1.0
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.0 + 0.3 / 1.3 * Math.sqrt(Math.log(10)), actionValues[0], 0.01);
        Assert.assertEquals(1.0 + 0.0 * Math.sqrt(Math.log(10) / 5), actionValues[1], 0.01);
        Assert.assertEquals(1.4 / 1.5 + 1.0 / 1.3 * Math.sqrt(Math.log(10) / 4), actionValues[2], 0.01);
        assertEquals(new LMRAction("Right"), node.treePolicyAction(false));
    }
    ...
    public void pUCT10VisitsWithTemperature() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.0 + 0.305 * Math.sqrt(Math.log(10)), actionValues[0], 0.01);
        Assert.assertEquals(1.0 + 0.262 * Math.sqrt(Math.log(10) / 5), actionValues[1], 0.01);
        Assert.assertEquals(1.4 / 1.5 + 0.433 * Math.sqrt(Math.log(10) / 4), actionValues[2], 0.01);
        assertEquals(new LMRAction("Right"), node.treePolicyAction(false));
    }
    ...
    public void actionSeeding10Visits() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals((-1.0 + 0.3 * 4) / 5.0 + Math.sqrt(Math.log(22) / 5), actionValues[0], 0.01);
        Assert.assertEquals(2.5 / 9.0 + Math.sqrt(Math.log(22) / 9), actionValues[1], 0.01);
        Assert.assertEquals((0.4 * 4 + 4.0) / 8.0 + Math.sqrt(Math.log(22) / 8), actionValues[2], 0.01);
        assertEquals(new LMRAction("Right"), node.treePolicyAction(false));
    }
    ...
    public void progressiveWideningI() {
        ...
        Assert.assertTrue(node.actionsToConsider(node.actionsFromOpenLoopState).contains(new LMRAction("Left")));
        Assert.assertTrue(node.actionsToConsider(node.actionsFromOpenLoopState).contains(new LMRAction("Right")));
        ...
        Assert.assertTrue(node.actionsToConsider(node.actionsFromOpenLoopState).contains(new LMRAction("Left")));
        Assert.assertTrue(node.actionsToConsider(node.actionsFromOpenLoopState).contains(new LMRAction("Right")));
        Assert.assertTrue(node.actionsToConsider(node.actionsFromOpenLoopState).contains(new LMRAction("Middle")));
    }
    ...
    public void fpuWithpUCT() {
        ...
        double[] actionValues = node.actionValues(baseActions);
        Assert.assertEquals(2.0 * 0.3 / 1.3, actionValues[0], 0.01);
        Assert.assertEquals(0.0, actionValues[1], 0.01);
        Assert.assertEquals(2.0 / 1.3, actionValues[2], 0.01);

        first10Visits(node);
        assertEquals(new LMRAction("Right"), node.treePolicyAction(false));
        actionValues = node.actionValues(baseActions);
        Assert.assertEquals(0.0 + 0.3 / 1.3 * Math.sqrt(Math.log(10)), actionValues[0], 0.01);
        Assert.assertEquals(1.0, actionValues[1], 0.01);
        Assert.assertEquals(1.4 / 1.5 + 1.0 / 1.3 * Math.sqrt(Math.log(10) / 4), actionValues[2], 0.01);
    }
    ...
    public void uniformSelection() {
        ...
        Assert.assertEquals(1000, counts[0] + counts[1] + counts[2]);
        Assert.assertEquals(333, counts[0], 75);
        Assert.assertEquals(333, counts[1], 75);
        Assert.assertEquals(333, counts[2], 75);
    }
    ...
    public void greedySelection() {
        ...
        Assert.assertEquals(1000, counts[0] + counts[1] + counts[2]);
        Assert.assertEquals(70, counts[0], 25);
        Assert.assertEquals(860, counts[1], 75);
        Assert.assertEquals(70, counts[2], 25);
    }
}
