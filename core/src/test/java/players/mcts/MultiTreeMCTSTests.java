...
public class MultiTreeMCTSTests {
    ...
    public void nodeCreatedIfGameOverMaxN() {
        ...
        Assert.assertEquals(0, problemNodes.size(), 15);
    ...
    public void multiTreeTestLoveLetter() {
        ...
        Assert.assertEquals(0, problemNodes.size(), 20);
        ...
        Assert.assertEquals(0, problemNodes.size(), 40);
        problemNodes = mctsPlayer.getRoot(1).nonMatchingNodes(actionVisitsAddUp);
        Assert.assertEquals(0, problemNodes.size());
        ...
        Assert.assertEquals(0, problemNodes.size(), 80);
    ...
    public void multiTreeTestLoveLetterRewards() {
        ...
        Assert.assertEquals(0, problemNodes.size(), 0);
