...
public class MASTRolloutMixture {
    ...
    public void classicMASTRolloutUpdatesStatisticsI() {
        ...
        Assert.assertTrue(player.getParameters().getRolloutStrategy() instanceof MASTPlayer);
        Assert.assertTrue(player.getParameters().useMAST);
        ...
        Assert.assertNull(node.MASTStatistics.get(0).get(new LMRAction("Middle")));
    ...
    public void mixtureRolloutPolicyUpdatesMASTStatistics() {
        ...
        MASTPlayer rolloutPlayer = (MASTPlayer) player.getParameters().rolloutPolicy;
        Assert.assertTrue(rolloutPlayer.getActionHeuristic() instanceof MASTPlusActionHeuristic);
        rolloutPlayer.setStats(node.MASTStatistics); // link rollout player to MAST statistics
