...
public class OMATests {
    ...
    public void omaNodesUsedTicTacToe() {
        ...
        Assert.assertEquals(0, problemNodes.size());

        // and check that we have non-zero values (so that OMA does normal back-prop)
        assertNotSame(0.0, mctsPlayer.getRoot(0).nodeValue(0));
        assertNotSame(0.0, mctsPlayer.getRoot(0).nodeValue(1));
    }
    ...
    public void omaParentsPopulatedOMA_AllTicTacToe() {
        ...
        Assert.assertFalse(((OMATreeNode) mctsPlayer.getRoot(0)).getOMAParent().isPresent());
    }
    ...
    public void omaStatisticsCorrectOMA_AllTicTacToe() {
        ...
        Assert.assertTrue(playerTwoNodes.size() > 5);
    }
    ...
    public void omaStatisticsCorrectOMA_AllLoveLetter() {
        ...
        Assert.assertTrue(playerTwoNodes.size() > 100);
    }
}
