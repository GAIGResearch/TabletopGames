...
public class GameFlow {
    ...
    public void redeterminisationShuffleOwnDeck() {
        ...
        assertNotSame(state.getPlayerDeck(1), copy.getPlayerDeck(1));
    }

    @Test
    public void redeterminisationShuffleOtherDeck() {
        ToadGameState copy = (ToadGameState) state.copy(1);
        assertNotSame(state.getPlayerHand(0), copy.getPlayerHand(0));
        assertNotSame(state.getPlayerDeck(0), copy.getPlayerDeck(0));
    }
