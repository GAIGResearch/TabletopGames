...
public class TestCantStop {
    ...
    public void testDiceAllocationMovesMarkers() {
        ...
        Assert.assertTrue(fm.computeAvailableActions(state).stream().allMatch(a -> a instanceof AllocateDice));
    ...
    public void testDoubleIsValidIfOnlyOneSpaceToMove() {
        ...
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(2, 6)));
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(4)));
    }
    ...
    public void testDoubleIsValidIfOneFreeMarker() {
        ...
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(6)));
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(8)));
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(7, 7)));
    }
    ...
    public void testDoubleIsNotValidIfOnlyOneStepLeftFromTempMarker() {
        ...
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(6, 8)));
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(7)));
    }
    @Test
    ...
    public void testPermanentPositionDoesNotInterfere() {
        ...
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(7, 8)));
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(10)));
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(5)));
    }
    ...
    public void checkGameTerminates() {
        ...
        state.moveMarker(3);
        fm.makeTemporaryMarkersPermanentAndClear(state);
        Assert.assertTrue(state.isNotTerminal());
        state.moveMarker(12);
        state.moveMarker(12);
        fm.makeTemporaryMarkersPermanentAndClear(state);
        assertEquals(0, state.getCurrentPlayer());
        Assert.assertFalse(state.isNotTerminal());
    ...
    public void testFourIdenticalDice() {
        ...
        List<AbstractAction> actions = fm.computeAvailableActions(state);
        Assert.assertEquals(1, actions.size());
        Assert.assertTrue(fm.computeAvailableActions(state).contains(new AllocateDice(2, 2)));
    }
