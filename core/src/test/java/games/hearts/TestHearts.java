...
public class TestHearts {
    ...
    public void testAfterAction() {
        ...
        Assert.assertFalse(gameState.getPlayerDecks().get(0).contains(cardToPass));

        // Assert that the card has been added to the pending passes of the player
        Assert.assertTrue(gameState.pendingPasses.get(0).contains(cardToPass));
    ...
    public void testRemovedCard() {
        ...
        Assert.assertFalse(containsRemovedCard);
    }
    ...
    public void testAfterActionPass() {
        ...
        Assert.assertFalse(gameState.getPlayerDecks().get(0).getComponents().contains(card));

        // Check that the card has been added to the pendingPasses
        Assert.assertTrue(gameState.pendingPasses.get(0).contains(card));
    }
    ...
    public void testComputeAvailableActionsFirstTurn() {
        ...
        Assert.assertTrue(actions.get(0) instanceof Play);
    ...
    public void testComputeAvailableActionsWithoutLeadSuit() {
        ...
        for (AbstractAction action : actions) {
            Assert.assertTrue(action instanceof Play);
            FrenchCard card = ((Play) action).card;
            Assert.assertTrue(playerDeck.contains(card));
        }
    }
    ...
    public void testEndTurnWithRoundWinner() {
        ...
        Assert.assertTrue(gameState.trickDecks.get(2).contains(play0.card));
        Assert.assertTrue(gameState.trickDecks.get(2).contains(play1.card));
        Assert.assertTrue(gameState.trickDecks.get(2).contains(play2.card));
    }
    ...
    public void testEndTurnTrickDeck() {
        ...
        Assert.assertTrue(gameState.currentPlayedCards.isEmpty());
    ...
    public void testGetDrawDeck() {
        ...
        Assert.assertTrue(gameState.getDrawDeck().contains(card));
    }
    ...
    public void testGetOrdinalPosition() {
        ...
        Assert.assertEquals(1, ordinal);  // Assuming that player 0 has more points than player 1
    }
