...
public class TestCraftsman {
    ...
    public void testCraftsmanGivesOptionsToSelectionPlayerForBonusGood() {
        ...
        Assert.assertTrue(actions.contains(new GainCrop(CORN, 1)));
        Assert.assertTrue(actions.contains(new GainCrop(INDIGO, 1)));
    }
    ...
    public void testNoSelectionOptionIfNoGoodsProduced() {
        ...
        List<AbstractAction> actions = fm.computeAvailableActions(state);
        Assert.assertEquals(6, actions.size());  // the other available roles
