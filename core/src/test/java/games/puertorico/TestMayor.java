...
public class TestMayor {
    ...
    public void testPlayerIsGivenOptionsToFillVacanciesUntilAllRemainingCanBeFilled() {
        ...
        Assert.assertTrue(actions.contains(new OccupyPlantation(PuertoRicoConstants.Crop.INDIGO)));
        Assert.assertTrue(actions.contains(new OccupyPlantation(PuertoRicoConstants.Crop.TOBACCO)));
    ...
    public void buildingsCanBeOccupiedAsWellAsPlantations() {
        ...
        Assert.assertTrue(actions.contains(new OccupyPlantation(PuertoRicoConstants.Crop.INDIGO)));
        Assert.assertTrue(actions.contains(new OccupyBuilding(PuertoRicoConstants.BuildingType.SMALL_INDIGO_PLANT)));
        Assert.assertTrue(actions.contains(new OccupyBuilding(PuertoRicoConstants.BuildingType.SUGAR_MILL)));
