...
public class TestRoleSelection {
    ...
    public void onlyAvailableRolesCanBeSelected() {
        ...
        Assert.assertTrue(actions.contains(new SelectRole(CAPTAIN)));
        Assert.assertTrue(actions.contains(new SelectRole(SETTLER)));
        Assert.assertTrue(actions.contains(new SelectRole(MAYOR)));
        Assert.assertTrue(actions.contains(new SelectRole(BUILDER)));
        Assert.assertTrue(actions.contains(new SelectRole(PROSPECTOR)));
        Assert.assertTrue(actions.contains(new SelectRole(TRADER)));
        Assert.assertTrue(actions.contains(new SelectRole(CRAFTSMAN)));
    ...
    public void gameEndsAtEndOfTriggeringRound() {
        ...
        Assert.assertFalse(state.isLastRound());
        state.setGameEndTriggered();
        Assert.assertTrue(state.isLastRound());
        ...
        Assert.assertEquals(4, roleOwners.size()); // all players had a turn
