 ...
 * way back down. Holding them in one object lets a node hold a set of data for each
 * simultaneously-moving player at a multi-actor node of a decoupled
 * search (or just one at every node of a sequential search).
 * This is a data holder with no behaviour and no back-reference to the node.
 */
