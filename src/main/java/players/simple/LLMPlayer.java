...
public class LLMPlayer extends AbstractPlayer {

    // Heuristics used for the agent
    StringHeuristic heuristic;

    public LLMPlayer(Random random) {
        super(null, "LLMPLayer");
        this.rnd = random;
        this.heuristic = new StringHeuristic();
    }
    ...
    public LLMPlayer(StringHeuristic heuristic, Random random) {
        super(null, "LLMPLayer");
        this.rnd = random;
    ...
    @Override
    public LLMPlayer copy() {
        LLMPlayer retValue = new LLMPlayer(heuristic, new Random(rnd.nextInt()));
