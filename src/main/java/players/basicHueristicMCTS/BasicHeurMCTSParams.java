...
public class BasicHeurMCTSParams extends PlayerParameters {
    ...
    @Override
    protected BasicHeurMCTSParams _copy() {
        ...
        return new BasicHeurMCTSParams();
    }
    ...
    @Override
    public BasicHeuristicMCTSPlayer instantiate() {
        return new BasicHeuristicMCTSPlayer((BasicHeurMCTSParams) this.copy());
    }
