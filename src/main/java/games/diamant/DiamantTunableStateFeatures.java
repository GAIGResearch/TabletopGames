...
public class DiamantTunableStateFeatures extends TunableStateFeatures {
    ...
    public DiamantTunableStateFeatures() {
        super(allNames);
    }
    @Override
    ...
    @Override
    protected DiamantTunableStateFeatures _copy() {
        return new DiamantTunableStateFeatures();
    }
