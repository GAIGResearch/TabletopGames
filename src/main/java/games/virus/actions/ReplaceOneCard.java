...
public class ReplaceOneCard extends DrawCard {
    ...
    public ReplaceOneCard(int deckFrom, int deckTo, int cardId, int deckDraw) {
        super(deckFrom, deckTo, cardId);
    ...
    public AbstractAction copy() {
        return new ReplaceOneCard(deckFrom, deckTo, cardId, deckDraw);
    }
}
