 ...
 */
public class PickominoGUIManager extends AbstractGUIManager {

    public PickominoGUIManager(GamePanel parent, Game game, ActionController ac, Set<Integer> human) {
