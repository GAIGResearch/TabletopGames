 ...
 * <p>They should also extend the {@link AbstractAction} class, or any other core actions. As such, all guidelines in {@link PickominoAction} apply here as well.</p>
 */
public class PickominoExtendedSequenceAction extends AbstractAction implements IExtendedSequence {

    // The extended sequence usually keeps record of the player who played this action, to be able to inform the game whose turn it is to make decisions
    final int playerID;

    public PickominoExtendedSequenceAction(int playerID) {
     ...
     */
    @Override
    public PickominoExtendedSequenceAction copy() {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof PickominoExtendedSequenceAction;
    }
