package games.pickomino.components;
 ...
 */
public class PickominoComponent extends Component {
    public PickominoComponent(CoreConstants.ComponentType type, String name) {
        super(type, name);
    }

    protected PickominoComponent(CoreConstants.ComponentType type, String name, int componentID) {
        super(type, name, componentID);
    }

    /**
     * @return Make sure to return an exact <b>deep</b> copy of the object, including all of its variables.
     * Make sure the return type is this class (e.g. PickominoComponent) and NOT the super class Component.
     * <p>
     ...
     */
    @Override
    public PickominoComponent copy() {
        PickominoComponent copy = new PickominoComponent(type, componentName, componentID);
    ...
    public boolean equals(Object o) {
        ...
        return (o instanceof PickominoComponent) && super.equals(o);
    }
