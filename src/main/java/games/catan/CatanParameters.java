...
public class CatanParameters extends AbstractParameters {
    ...
    // rules
    public int max_negotiation_count = 0; // max number of attempts to renegotiate player trade
    ...
    public int max_trade_actions_allowed = 0; // max number of trade actions per turn
