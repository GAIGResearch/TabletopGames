...
public class ChooseCard extends AbstractAction {
    ...
    public ChooseCard(int chosenCard, int chosenPlayer, boolean look) {
    ...
    public ChooseCard copy() {
        ...
        ChooseCard trash = new ChooseCard(chosenCard,chosenPlayer,look);
        return trash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof ChooseCard
                && ((ChooseCard) obj).chosenCard==chosenCard
                && ((ChooseCard) obj).chosenPlayer==chosenPlayer
                && ((ChooseCard) obj).look==look;
    }

    @Override
    public int hashCode() {

        return Objects.hash(chosenCard,chosenPlayer,look);
    }

    @Override
    public String toString() {
        // TODO: Replace with appropriate string, including any action parameters
        return "Choosing card "+chosenCard+ "from player "+chosenPlayer+" do i look at it? "+look ;
    }
