 ...
 */
public class ChooseSwap extends AbstractAction {
    boolean decision;

    public ChooseSwap(boolean choice) {
     ...
     */
    @Override
    public ChooseSwap copy() {
        // TODO: copy non-final variables appropriately
        ChooseSwap copy = new ChooseSwap(decision);
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof ChooseSwap
                && ((ChooseSwap) obj).decision==decision;
    }
