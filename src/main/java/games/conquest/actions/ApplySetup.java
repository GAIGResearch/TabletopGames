...
import games.conquest.CQForwardModel;
 ...
 */
public class ApplySetup extends AbstractAction {
    CQParameters.Setup setup;

    public ApplySetup(String setup) {
        this.setup = CQParameters.Setup.valueOf(setup);
    }
    public ApplySetup(CQParameters.Setup setup) {
        this.setup = setup;
    }
    ...
    public boolean execute(AbstractGameState gs) {
        ...
        cqgs.setupTroopsFromString(setup.troops, cqgs.getCurrentPlayer());
        cqgs.setupCommands(setup.commands, cqgs.getCurrentPlayer());
        System.out.println("Playing with setup " + this.setup);
        return true;
    }

    @Override
    public ApplySetup copy() {
        return this;
    }

    @Override
    public boolean equals(Object obj) {
        return obj instanceof ApplySetup && ((ApplySetup) obj).setup.equals(setup);
    }
