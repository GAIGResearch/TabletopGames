 ...
 */
public class CQComponent extends Component {
    public CQComponent(CoreConstants.ComponentType type, String name) {
        super(type, name);
    }

    protected CQComponent(CoreConstants.ComponentType type, String name, int componentID) {
     ...
     */
    @Override
    public CQComponent copy() {
        CQComponent copy = new CQComponent(type, componentName, componentID);
    ...
    public boolean equals(Object o) {
        ...
        return (o instanceof CQComponent) && super.equals(o);
    }
