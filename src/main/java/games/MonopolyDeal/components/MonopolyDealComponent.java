 ...
 */
public class MonopolyDealComponent extends Component {
    public MonopolyDealComponent(CoreConstants.ComponentType type, String name) {
        super(type, name);
    }

    protected MonopolyDealComponent(CoreConstants.ComponentType type, String name, int componentID) {
     ...
     */
    @Override
    public MonopolyDealComponent copy() {
        MonopolyDealComponent copy = new MonopolyDealComponent(type, componentName, componentID);
    ...
    public boolean equals(Object o) {
        ...
        return (o instanceof MonopolyDealComponent) && super.equals(o);
    }
