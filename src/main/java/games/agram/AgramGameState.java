 ...
 *     <li>currentTrick - the trick in progress, VISIBLE_TO_ALL. Its leader led it; once a trick is complete the
 *     leader is its winner, who leads the next; after the last trick of a deal it is the winner of the deal</li>
...
public class AgramGameState extends AbstractGameState implements ITrickTakingState {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), playerHands, drawDeck, currentTrick, discardPile, knownVoids)
