...
public class Wail extends TriggerAttributeTest {
    ...
    public List<AbstractAction> _computeAvailableActions(AbstractGameState state) {
        ...
        return List.of(new WailTest(target, Figure.Attribute.Willpower, attacker));
    }
    ...
    public String toString() {
        return super.toString().replace("Call Attribute Test", "Wail");
    }

    @Override
    public String getString(AbstractGameState gameState) {
        return super.getString(gameState).replace("Call Attribute Test", "Wail");
    }
