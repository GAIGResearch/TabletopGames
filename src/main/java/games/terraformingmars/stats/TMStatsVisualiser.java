...
//                this.gameLogger = (SummaryLogger) list.getLoggers().get(Event.GameEvent.GAME_OVER);
//            } else if (list instanceof TMPlayerListener) {
//                this.playerLoggers = (SummaryLogger[]) ((TMPlayerListener) list).loggerArray;
//                this.playerAggregateLogger = (SummaryLogger) list.getLoggers();
//            }
//        }
//
...
//
//        // Generation average
//        TAGNumericStatSummary stats = gameLogger.summary().get(TMGameAttributes.GENERATION.name());
...
//        c.gridy = 4;
//        stats = gameLogger.summary().get(TMGameAttributes.GP_OCEAN_COMPLETE_GEN.name());
...
//        c.gridy = 6;
//        stats = gameLogger.summary().get(TMGameAttributes.GP_OXYGEN_COMPLETE_GEN.name());
...
//        c.gridy = 8;
//        stats = gameLogger.summary().get(TMGameAttributes.GP_TEMPERATURE_COMPLETE_GEN.name());
...
//        c.gridx = 1;
//        c.gridy = 0;
//        stats = gameLogger.summary().get(TMGameAttributes.MAP_COVERAGE.name());
...
//        fm.setup(gs);
//        TAGOccurrenceStatSummary stats2 = gameLogger.summaryStringData().get(TMGameAttributes.MAP_TILES.name());
...
//        getContentPane().add(Box.createRigidArea(new Dimension(0, 20)), c);
//        c.gridy = 11;
//        stats = gameLogger.summary().get(TMGameAttributes.POINT_DIFF.name());
...
//        TAGOccurrenceStatSummary summary = playerAggregateLogger.summaryStringData().get(TMPlayerListener.TMPlayerAttributes.CARDS_PLAYED_WIN.name());
//        TAGOccurrenceStatSummary summary2 = playerAggregateLogger.summaryStringData().get(TMPlayerListener.TMPlayerAttributes.CARDS_PLAYED.name());
