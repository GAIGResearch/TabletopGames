...
public class Game {
    ...
    public static void main(String[] args) {
        String gameType = Utils.getArg(args, "game", "TheGame");
...
//        players.add(new RandomPlayer());
        ...
        BasicHeurMCTSParams params1 = new BasicHeurMCTSParams();
        params1.comms = new BasicMCTSCommunicator();
        players.add(new BasicHeuristicMCTSPlayer(params1, "MCTS 1"));

        BasicHeurMCTSParams params2 = new BasicHeurMCTSParams();
        params2.comms = new BasicMCTSCommunicator();
        players.add(new BasicHeuristicMCTSPlayer(params2, "MCTS 2"));
