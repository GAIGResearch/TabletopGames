...
public class ParameterSearch {
    ...
    public static void main(String[] args) {
        ...
        if (getArg(args, "opponent", "").isEmpty()) {
            ...
            NTBEA singleNTBEA = new NTBEA(landscapeModel, new NTBEAParameters(args));
            singleNTBEA.run();
    ...
    public static void runMultiNTBEA(NTupleSystem landscapeModel, String[] args) {
        ...
        for (int mainLoop = 0; mainLoop < repeats; mainLoop++) {
            ...
            NTBEA.printDetailsOfRun(retValue, searchSpace, logfile, verbose, null);
        ...
        NTBEA.printDetailsOfRun(bestResult, searchSpace, "", false, null);
    }
