...
public class GLGUIManager extends AbstractGUIManager{

    protected GLGamePanel parent;
    ...
    public GLGUIManager(GLGamePanel parent, ActionController ac, int maxActionSpace) {
